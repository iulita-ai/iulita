...
type AgentJob struct {
	...
	UserID         string    `bun:",notnull,default:''" json:"user_id"` // owner; "" = admin-global legacy job
	...
	WakeGatePrompt string    `bun:",notnull,default:''" json:"wake_gate_prompt"` // optional cheap pre-check; skip the run if it returns the skip sentinel
