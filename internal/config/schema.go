	...
	return []ConfigSection{
		...
		},
		{
			...
			Fields: []ConfigField{
				...
				{Key: "routing.default_provider", Label: "Default Provider", Description: "Active LLM for normal queries (e.g. switch claude→deepseek). Requires that provider's API key/model to be set and a 2nd provider configured. Applies live (no restart).", Type: FieldSelect, Default: "claude", Options: []string{"claude", "openai", "deepseek", "ollama"}, Section: "routing"},
